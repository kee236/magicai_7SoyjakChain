 ...
 * ==========================================================
 *
 * API main file. This file listens the POST queries and return the result. © 2022-2024 boxcoin.dev. All rights reserved.
 *
 */
...
if (isset($_GET['cron']) && isset($_GET['api-key'])) {
    $_POST['api-key'] = bxc_sanatize_string($_GET['api-key']);
    bxc_api_verify_key();
    bxc_cron();
    die();
}
