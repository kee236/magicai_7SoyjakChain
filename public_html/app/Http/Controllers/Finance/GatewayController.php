...
use App\Services\BoxcoinApiClient;
...
class GatewayController extends Controller
{
    ...
    public function gatewayCodesArray(): array
    {
        ...
        if (class_exists('App\Services\PaymentGateways\CryptomusService')) {
         ...
         if (class_exists('App\Services\BoxcoinApiClient')) {
            $paymentGateways[] = 'boxcoin';
        }
    ...
    public function defaultGatewayDefinitions(): array
    {
        ...
        if (class_exists('App\Services\PaymentGateways\CryptomusService')) {
         ...
         if (class_exists('App\Services\BoxcoinApiClient')) {
        $gateways[] = BoxcoinApiClient::gatewayDefinitionArray(); // Include the Boxcoin gateway
    }
        if (class_exists('App\Services\PaymentGateways\MidtransService')) {
