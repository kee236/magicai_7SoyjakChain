...
class ChatbotTrainingController extends Controller
{
    public function qa(Request $request, Chatbot $chatbot)
    {
        if (Helper::appIsDemo()) {
            return response()->json([
                ...
                'content' => view('panel.user.chat.chatbot.particles.qa.list', [
    ...
    public function text(Request $request, Chatbot $chatbot)
    {
        if (Helper::appIsDemo()) {
            return response()->json([
                'status' => 'error',
                'message' => trans('This feature is disabled in demo mode.'),
                'content' => view('panel.user.chat.chatbot.particles.text.list', [
    ...
    public function uploadPdf(Request $request, Chatbot $chatbot)
    {
        if (Helper::appIsDemo()) {
            return response()->json([
                'status' => 'error',
                'message' => trans('This feature is disabled in demo mode.'),
                'content' => view('panel.user.chat.chatbot.particles.pdf.list', [
    ...
    {
        return response()->json([
            'content' => view('panel.user.chat.chatbot.particles.web-site.crawler', [
    ...
    public function training(
        ...
        $matchView = match ($type) {
            'url' => 'panel.user.chat.chatbot.particles.web-site.crawler',
            'pdf' => 'panel.user.chat.chatbot.particles.pdf.list',
            'text' => 'panel.user.chat.chatbot.particles.text.list',
            'qa' => 'panel.user.chat.chatbot.particles.qa.list',
        };
