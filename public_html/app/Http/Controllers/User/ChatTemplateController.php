...
class ChatTemplateController extends Controller
{
    public function index()
    {
        ...
        return view('panel.user.chat.template.index', compact('list'));
    }
    ...
    public function create()
    {
        ...
        return view('panel.user.chat.template.form', [
            'method' => 'POST',
    ...
    public function destroy(OpenaiGeneratorChatCategory $chatTemplate)
    {
        if (Helper::appIsDemo()) {
