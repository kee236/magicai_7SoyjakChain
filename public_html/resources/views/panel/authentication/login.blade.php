                ...
                <div class="flex flex-col justify-center col-lg-6">
                    <div class="row">
                        <div class="mx-auto col-lg-6">
                            <h1 class="text-center mb-9 mt-3">{{ __('Sign in') }}</h1>
                            <div class="flex flex-wrap !gap-4 text-[13px] -tracking-[0.15px]] mb-2 cursor-pointer">
                                <div x-data @click="window.connectWallet('register')"
                                    class="flex items-center w-[calc(50%-0.5rem)] z-10 grow !py-3 !px-4 border border-[--tblr-border-color] rounded-[10px] !no-underline text-heading transition-all hover:shadow-lg hover:-translate-y-1 cursor-pointer">

                                    <svg fill="none" height="45" viewBox="0 0 600 350" width="45"
                            ...
                            <form novalidate="novalidate" onsubmit="return LoginForm();">
                                ...
                                <div class="mb-[20px]">
                                    ...
                                    <input type="email" class="form-control" id="email"
                                        ...
                                        value="{{ $app_is_demo ? 'admin@admin.com' : '' }}" autocomplete="off">
                                </div>
                                <div class="mb-[25px]">
                            ...
                            {{-- <div x-data class="row mt-[35px]">
								
                                <div class="col">
                                    <button @click="window.connectWallet('login')" style="background-color:cornflowerblue" id="RegisterFormButton" class="btn btn-primary w-100">{{__('Wallet Connect')}}</button>
                                </div>
                            </div> --}}
                            ...
                            @if ($setting->register_active == 1)
                                <div class="mt-20 text-center text-muted">
                                    {{ __("Don't have account yet?") }} <a
                                        href="{{ route('register', ['plan' => $plan]) }}" tabindex="-1"
