...
>
    ...
    <div class="container relative">
        <div class="mx-auto flex flex-col items-center max-lg:w-2/3 max-md:w-full heresection">
{{--            <h6--}}
...
{{--            </h6>--}}
{{--            <span class="morethameme">More than a meme. Let <img src="{{ asset('images/img.png') }}" style="display: inline;" width="90" height="90"> run your creativity wild!</span>--}}
            <span class="morethameme">Generative AI Creator Hub on Web 3</span>
            <div class="banner-title-wrap relative mt-5">
                <span class="soyjakintuitive"> More than a meme. Let Soyjak run your creativity wild! Pick your tools, generate your AI content, & secure your IPR with a blockchain-verifiable timespan.</span>
                <h1
...
{{--                    {!! __($fSetting->hero_scroll_text) !!}--}}
                Discover Creator Hub
                </a>
            </div>
        </div>
        <a class="opacity-50 transition-opacity hover:opacity-100" style="font-size: 24px !important; display: block"
           href="#features">
            Await our next gen marketplace for AI <br> digital arts on web 3
        </a>
    </div>
