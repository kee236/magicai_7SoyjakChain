...
<x-card
        ...
        activeGenerator: '{{ setting('dalle_hidden', 0) == 1 ? 'stablediffusion' : 'dall-e' }}',
...
>
    <div class="mb-5 flex flex-wrap justify-between">
        <div class="lqd-image-generator-tabs-nav flex gap-1">
            ...
            @if(\App\Helpers\Classes\Helper::setFalAIKey())
                @includeWhen(\Illuminate\Support\Facades\Route::has('dashboard.admin.settings.fal-ai'),viewName('panel.user.openai.includes.flux-pro-tab'))
            @endif
        </div>
    ...
    @if(\App\Helpers\Classes\Helper::setFalAIKey())
        @includeWhen(\Illuminate\Support\Facades\Route::has('dashboard.admin.settings.fal-ai'),viewName('panel.user.openai.includes.flux-pro-tab-body'))
    @endif
...
@push('script')
    ...
    @includeWhen(\Illuminate\Support\Facades\Route::has('dashboard.admin.settings.fal-ai'),viewName('panel.user.openai.includes.flux-pro-script'))
