    ...
    <div class="py-10">
        ...
        >
            ...
            >
                ...
                >
                    <x-button
                        class="chats-sidebar-expander size-10 absolute start-0 top-5 z-[99] hidden -translate-x-1/2 place-content-center rounded-full bg-background text-heading-foreground shadow-md shadow-heading-foreground/10 hover:translate-y-0 hover:scale-105 dark:bg-background lg:group-[&.focus-mode]/body:inline-grid"
                        variant="ghost-shadow"
                        size="none"
                        href="#"
                        @click.prevent="if ( $store.focusMode.active ) { sidebarHidden = !sidebarHidden }"
                    >
                        <span
