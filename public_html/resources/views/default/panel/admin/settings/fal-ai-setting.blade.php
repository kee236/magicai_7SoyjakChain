        ...
        <div class="row">
            ...
            >
                @if ($app_is_demo)
                    <div class="col-md-12">
                        <div class="mb-3">
                            <label class="form-label">{{ __('FAL AI API Secret') }}</label>
                            <input
                                    class="form-control"
                ...
                @else
                    <div class="col-md-12">
                        <div
                            ...
                            <label class="form-label">{{ __('FAL AI API key') }}</label>
            ...
            >
                <div class="mb-3">
                    <label class="form-label">{{ __('Default Gemini Model') }}</label>
                    <select
                            class="form-select"
                    ...
                    >
                        @foreach($ai_models as $mo)
                            <option {{ setting('fal_ai_default_model') == $mo->key ? 'selected' : '' }} value="{{ $mo->key }}">{{ $mo->title }}</option>
                        @endforeach
                    </select>
                </div>
            </x-card>
